...
export function AiChat({ initialSessionId, mode: forcedMode }: AiChatProps) {
  ...
  const handleSend = async () => {
    ...
    // Reserve a line for the streaming assistant response
    const assistantLineIndex = logLines.length + 1; // +1 for the "You:" line just added
    streamLineIndexRef.current = assistantLineIndex;
    streamBufferRef.current = "";
