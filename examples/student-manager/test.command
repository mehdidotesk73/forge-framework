#!/usr/bin/env bash
# test — start the dev server and open the app in a browser.
set -euo pipefail

PROJECT_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
APP_DIR="$PROJECT_ROOT/apps/test"
PORT=5177
...
echo "→ Starting test dev server on :$PORT..."
...
echo "✓ test running at http://localhost:$PORT"
